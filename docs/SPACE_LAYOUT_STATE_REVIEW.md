...
2026-09-10 · 코드 기준 `09f9d67` · **설계 검토안, 미구현**
...
| S17 | 자동 저장 ON·A+B 연결을 유지한 채 B의 저장 창을 사용자가 내장 화면으로 옮김 | 확인된 같은 창의 외장 위치 기록을 새 이력에서 빼고, 다음 저장 완료 뒤에는 그 창을 외장으로 복원하지 않음. 저장 완료 전 복원은 기존 저장 위치 사용. 화면 분리로 내장에 모인 W17과 구분 |
